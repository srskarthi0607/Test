Below are the commands which can be passed to the Syncfusion.Bigdata.ThriftApplication and in SPARK-SHELL
...
Uploading the data set to the HDFS:
	...
	or 
	We can use Spark shell provided in Big Data Studio to connect with cluster and execute commands.
